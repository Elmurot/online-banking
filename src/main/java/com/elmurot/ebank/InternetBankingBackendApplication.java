package com.elmurot.ebank;

import com.elmurot.ebank.AccountOperation.AccountOperationEntity;
import com.elmurot.ebank.AccountOperation.AccountOperationRepository;
import com.elmurot.ebank.BankAccount.*;
...
import com.elmurot.ebank.Customer.CustomerRepository;
...
import com.elmurot.ebank.Security.SecurityService;
...
public class InternetBankingBackendApplication {
    ...
    CommandLineRunner commandLineRunner1(BankService bankService, SecurityService securityService){
        return args -> {
            ...
            securityService.addNewUser(new AppUser(null,"ELMUROT","1234",null));
            securityService.addNewUser(new AppUser(null,"DILMUROD","3456",null));
            securityService.addNewUser(new AppUser(null,"ANVAR","5678",null));
            ...
            securityService.addRoleToUser("ELMUROT", "ADMIN");
            securityService.addRoleToUser("ELMUROT", "USER");
            securityService.addRoleToUser("DILMUROD", "USER");
            securityService.addRoleToUser("DILMUROD", "PRODUCT_MANAGER");
            securityService.addRoleToUser("ANVAR", "USER");
        };
    }
    //@Bean
