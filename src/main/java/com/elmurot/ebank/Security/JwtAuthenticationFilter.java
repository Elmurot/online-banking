...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    * formulaire*/
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        // English: Store both variables in a UsernamePasswordAuthenticationToken object which expects two parameters

        UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = new UsernamePasswordAuthenticationToken(
                username, password);
        //English: authenticate is the method that does all the operations of searching the database and sending it roles\
        // and all that...until the arrival at password verification
